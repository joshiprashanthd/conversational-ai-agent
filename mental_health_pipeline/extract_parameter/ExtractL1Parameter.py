from lib.groq_model import Groq, GroqModel
...
class ExtractL1Parameter:
    ...
    def build_prompt(
        self, answers: TExtractL1ParameterInput, parameters: List[str]
    ) -> None:
...
"""
        ...
        self.prompt = self.prompt.format(
            qnas=qnas_str, parameters=", ".join(parameters)
        )
