...
def parse_llm_response(response):
    ...
    parsed_question['correctAnswer'] = correct_answer_match.group(1) if correct_answer_match else ""
    parsed_question['explanation'] = explanation_match.group(1) if explanation_match else ""
...
for idx, abstract in enumerate(data):
    ...
    #validating
    validation_response = validate_topic(subject=questions_parsed["subject"], topic=questions_parsed["topic"])
