...
class Llama3_8BGroq(GroqModel):
    def __init__(self):
        super().__init__("Llama-3-8B-Groq", "llama3-8b-8192")


class Llama3_70BGroq(GroqModel):
    def __init__(self):
        super().__init__(name="Llama3-70B-Groq", model_id="llama3-70b-8192")


class Mixtral8x7BGroq(GroqModel):
    def __init__(self):
        super().__init__(name="Mixtral8x7B-Groq", model_id="mixtral-8x7b-32768")


class Llama3_1_405B_Reasoning(GroqModel):
    def __init__(self):
        super().__init__(
            name="Llama-3.1-405B-Reasoning", model_id="llama-3.1-405b-reasoning"
        )
...
class Llama3_1_70B_Versatile(GroqModel):
    def __init__(self):
        super().__init__(
            name="Llama-3.1-70B-Versatile", model_id="llama-3.1-70b-versatile"
        )


class Llama3_1_8B_Instant(GroqModel):
    def __init__(self):
        super().__init__(name="Llama-3.1-8B-Instant", model_id="llama-3.1-8b-instant")
